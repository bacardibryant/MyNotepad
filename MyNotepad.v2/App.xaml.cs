...
namespace MyNotepad.v2
{
    ...
    {
        // Get a reference to the root frame out list of the application launch so that it can be used
        // in downstream methods as well.
        ...
        // Override existing OnLaunched with code to leverage jump lists.
